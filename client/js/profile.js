...
async function loadUserProfile() {
  ...
  responseData.forEach((users) => {
      ...
      imageDiv.id = `imageDiv${users.user_id}`
      imageDiv.className = `imageDiv`
      let infoDiv = document.createElement('div')
      infoDiv.id = `allResultsDiv${users.user_id}`
      infoDiv.className = `allResultsDiv`
      ...
      infoDiv.append(usersName, usersUserName, usersAge)
